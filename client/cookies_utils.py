...
class CookiesUtils:
    ...
    def process_and_save(
        ...
        for cookie in cookies:
            ...
            ep_for_cookie = None
            if set_by_url:
                # Find the request log entry for this cookie's Set-Cookie request
            ...
            single_cookie_metadata = {
                ...
                "set_by_request_url": network_context.get("set_by_request_url"),
                "set_by_request_type": network_context.get("set_by_request_type"),
                "set_by_initiator": network_context.get("set_by_initiator"),
                "is_third_party_set": network_context.get("is_third_party_set"),
                "set_by_easyprivacy_tracker": (
                    ep_for_cookie.get("matched", False) if ep_for_cookie else None
                ),
                "set_by_easyprivacy_pattern": (
                    ep_for_cookie.get("pattern") if ep_for_cookie else None
                ),
                "md5_value": md5(
